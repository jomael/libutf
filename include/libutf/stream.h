...
typedef utf_byte_index_t (*utf_seek_callback_t)(void * data, utf_byte_index_t index);

typedef utf_byte_index_t (*utf_tell_callback_t)(void * data);
...
utf_bit_count_t utf_stream_get_bits(const utf_stream_t * stream);

void * utf_stream_get_data(utf_stream_t * stream);

const void * utf_stream_get_data_const(const utf_stream_t * stream);

utf_byte_index_t utf_stream_seek(utf_stream_t * stream, utf_byte_index_t index);

utf_byte_index_t utf_stream_tell(utf_stream_t * stream);

void utf_stream_set_bits(utf_stream_t * stream);
